...
describe('durationToString', () => {
	...
	it('Test Case 13h 14 min 15 sec', () => {
		const str = durationToString(
			13 * 60 * 60 * 1000 + 14 * 60 * 1000 + 15 * 1000,
		);
		expect(str).toBe('13h 14m');
	});

	it('Test Case 25h 12min', () => {
		const str = durationToString(25 * 60 * 60 * 1000 + 12 * 60 * 1000);
		expect(str).toBe('1d 1h');
	});
});
