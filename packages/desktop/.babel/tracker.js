...
exports.ActiveWindowWatcher = void 0;

var _activeWin = _interopRequireDefault(require('active-win'));
...
class ActiveWindowWatcher {
	...
	tracker() {
		setInterval(async () => {
			const activeWindow = await (0, _activeWin.default)();
...
exports.ActiveWindowWatcher = ActiveWindowWatcher;
